function td_data = load_atis_data_2_le_retour(filename,path, flipX, flipY)
...
if nargin==0 % if no input, asks you for a file
    [filename,path,filterindex]=uigetfile('*','Select recorded retina data file');
    if filename==0 
        return; 
    end
elseif nargin == 1
