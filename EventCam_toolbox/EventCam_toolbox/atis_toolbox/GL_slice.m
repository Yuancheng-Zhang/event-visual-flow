function [It,Time,evt]=GL_slice(AE,is,ie,timeslot,mode)
...
%Example of use:
%
%[It,T]=GL_slice(AE_struct,start_idx,end_idx,timeslot,mode); 
%
%[It,T]=GL_slice(AE_struct,1,length(AE.t),1e-3,0) 
